...
function renderOrders(){
    ...
    orders.forEach((order,index)=>{
        ...
        if(!order.done){
            ...
            completeBtn.onclick=()=>{ order.done=true; saveOrders(); renderOrders(); };
            li.appendChild(completeBtn); li.appendChild(deleteBtn);
            orderList.appendChild(li);
        } else {
            li.classList.add("done"); li.appendChild(deleteBtn); completedOrders.appendChild(li);
        }
    });
}
...
orderBtn.addEventListener("click", ()=>{
    ...
    clientName.value=""; phoneNumber.value=""; dressType.value=""; eventDate.value=""; measurements.value="";
});
...
function renderAppointments(){
    ...
    appointments.forEach((app,index)=>{
        ...
        delBtn.onclick=()=>{ appointments.splice(index,1); saveAppointments(); renderAppointments(); };
        li.appendChild(delBtn); appointmentList.appendChild(li);
    });
}
...
appointmentBtn.addEventListener("click",()=>{
    ...
    saveAppointments(); renderAppointments();
    appName.value=""; appPhone.value=""; appointmentDate.value="";
});
